...
Il il diagramma in Figura ~\ref{fig:ClassDiagramInterfaces} serve a rappresentare le interfacce del sistema e le loro interazioni.
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.27]{ClassDiagramInterfaces_v2.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.27]{ClassDiagramTypes_v1.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.4]{DeploymentDiagram_v3.png}
