...
\subsubsection{UC1.2 Nuova prenotazione}
...
\subsubsection{UC1.4 Elimina prenotazione}
...
\begin{figure}[htbp]
    \includegraphics[scale=0.7]{iterazione2/ClassDiagramInterfaces_v1.png}
    \centering
...
\begin{figure}[htbp]
    \includegraphics[width=\textwidth]{iterazione2/DeploymentDiagram_v1.png}
    \centering
